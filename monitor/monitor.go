...
func (m *Monitor) do_build(image gearTypes.Image) error {
    ...
    _, err = m.Client.ImagePush(m.Ctx, m.RegistryIp+":"+m.RegistryPort+"/"+image.Repository+"-gear"+":"+image.Tag, types.ImagePushOptions{RegistryAuth: "123"})
    if err != nil {
