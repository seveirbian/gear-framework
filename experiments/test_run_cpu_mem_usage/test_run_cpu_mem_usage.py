...
class Puller:
        ...
        for repo in repos:
            ...
            for tag in tags:
                ...
                try:
                    ...
                    if cmds != {}:
                        container, createTime, appTime, startupTime, cpu_usage, mem_usage = self.startup(client, repo, cmds)
                    ...
                    self.record(repo, tag, image_pulled.attrs[u'Size']/1024.0/1024.0, pullTime, createTime, appTime, startupTime, cpu_usage, mem_usage)
    ...
    def startup(self, client, repo, cmds):
        ...
        if cmds["waitline"] != "hello":
            stat = container.stats(stream=False)
            cpu_usage = 1.0 * stat[u'cpu_stats'][u'cpu_usage'][u'total_usage'] / stat[u'cpu_stats'][u'system_cpu_usage'] * stat[u'cpu_stats'][u'online_cpus']
            mem_usage = stat[u'memory_stats'][u'usage']/1024.0/1024.0
        else:
            cpu_usage = 0
            mem_usage = 0

        return container, createTime, appTime, startupTime, cpu_usage, mem_usage

    def record(self, repo, tag, size, pullTime, createTime, appTime, startupTime, cpu_usage, mem_usage):
        self.result.append([repo, str(tag), size, pullTime, createTime, appTime, startupTime, cpu_usage, mem_usage])
