...
runEnvironment = []
runPorts = {"2368/tcp": hostPort, }
runVolumes = {os.path.join(pwd, "project"): {'bind': '/home/gradle/project/', 'mode': 'rw'},}
runWorking_dir = "/home/gradle/project/"
runCommand = "gradle -q hello"
