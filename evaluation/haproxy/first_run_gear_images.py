...
import shutil
import xlwt
# package need to be installed, pip install pika
import pika
...
runVolumes = {os.path.join(pwd, "myhaproxy.cfg"): {'bind': '/usr/local/etc/haproxy/haproxy.cfg', 'mode': 'rw'},}
runWorking_dir = ""
runCommand = ""
waitline = ""
